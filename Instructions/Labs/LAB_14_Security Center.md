...
1. On the **Settings \| Auto Provisioing** blade, make sure that **Auto provisioning** to **On** for the first item **Log Analytics agent for Azure VMs**. 

1. On the **Settings \| Auto Provisioning** blade, next to in the first item **Log Analytics agent for Azure VMs** in the **Configuration** column select **Edit Configurations**. In the **Workspace configuration** section, select the **Use another workspace** option and, in the drop-down list, select the Log Analytics workspace you created in the previous lab. 
